...
<!--页面顶部 开始-->
<#include "header.ftl">
<#--(1.assign)将JSON字符串的图片转成(2.?eval)对象(定义)-->
		...
		<div id="item">
			...
			<div class="product-info">
				...
				<div class="fr itemInfo-wrap">
					<div class="sku-name">
						<h4>{{sku.title}}</h4><#--//加载默认SKU,第一个...${goods.goodsName}spu改成sku[0]-->
					</div>
					<div class="news">${goods.caption}<span></span></div>
					<div class="summary">
						...
						<#--外循环:规格-name-->
							...
							<dl>
								...
								<#list spec.attributeValue as item><#---->
																<#--再从对象取出key==value则显示样式-->
									<dd><a href="javascript:;" class="{{isSelectSpec('${spec.attributeName}','${item}')?'selected':''}}"
																<#--选中规格存进对象-->
						...
						<div class="summary-wrap">
							<div class="fl title">
								<div class="control-group">
									<div class="controls"><#--商品数量$scope.num+=x-->
							...
							<div class="fl">
								<ul class="btn-choose unstyled">
									<li>
										<a href="#"  class="sui-btn  btn-danger addshopcar" ng-click="addToCar()">加入购物车</a>
									</li>
								</ul>
							</div>
						</div>
